...
// MVVM injects values into the VC's dependent views
...
public struct MvvmViewModel {
    ...
    let model = MvvmModel(backgroundColor: UIColor.greenColor(), imageURL: "http://images.urbanoutfitters.com/is/image/UrbanOutfitters/20611299_021_b", name: "Nail Polish", price: "$10.0")
